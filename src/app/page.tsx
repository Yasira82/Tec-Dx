...
const APP_URL    = httpOr(process.env.NEXT_PUBLIC_APP_URL, 'https://dx.tecosystem.app');
const APP_NAME   = process.env.NEXT_PUBLIC_APP_NAME   ?? 'TEC DX';
    ...
    <div style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: 13, color: TEC_COLORS.subtext, marginBottom: 6 }}>
          TEC ECOSYSTEM · DEVELOPERS
        </div>
        <div style={{ fontSize: 13, color: TEC_COLORS.subtext, marginBottom: 32, maxWidth: 320, lineHeight: 1.5 }}>
          Build on Pi — SDKs, templates, capabilities, and guides. The developer
          platform for the Pi economy.
        </div>
        <button
          onClick={handleLogin}
          disabled={isLoading}
